...
$hedefKlasor = __DIR__ . '/post_images/'; // Dosyanın kaydedileceği klasörün yolu
...
try {
    ...
    echo str_replace("\\",'/',"http://".$_SERVER['HTTP_HOST'].substr(getcwd(),strlen($_SERVER['DOCUMENT_ROOT']))."/post_images/") . $yol;
} catch (Exception $e) {
    echo false;
}
