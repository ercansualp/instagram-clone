...
$hedefKlasor = __DIR__ . '/profiles/'; // Dosyanın kaydedileceği klasörün yolu
...
try {
    ...
    echo str_replace("\\",'/',"http://".$_SERVER['HTTP_HOST'].substr(getcwd(),strlen($_SERVER['DOCUMENT_ROOT']))."/profiles/") . $yol;
} catch (Exception $e) {
    echo false;
}
