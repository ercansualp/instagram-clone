...
export default function PostOptions({open, setOpen, deletePost, post, currentuser, setOpenPostDialog}) {
    ...
    return (
        ...
        >
            ...
            >
                <Item style={{color: "rgb(237, 73, 86)"}} onClick={deletePost}>Sil</Item>
