export const InstagramLogo = () => {
    return (
        <svg aria-label="Instagram" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="29" role="img"
             viewBox="32 4 113 32" width="103"><title>Instagram</title>
...
export const HomeIcon = ({isActive}) => {
    if (isActive) {
        ...
        return (
            <svg aria-label="Ana Sayfa" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
                 viewBox="0 0 24 24" width="24"><title>Ana Sayfa</title>
                <path
...
export const MoreIcon = () => {
    return (
        <svg aria-label="Ayarlar" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor"
             height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Ayarlar</title>
...
export const SettingsIcon = () => {
    return (
        <svg aria-label="Ayarlar" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18" role="img"
             viewBox="0 0 24 24" width="18"><title>Ayarlar</title>
...
export const MovementsIcon = () => {
    return (
        <svg aria-label="Hareketlerin" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18" role="img"
             viewBox="0 0 24 24" width="18"><title>Hareketlerin</title>
            <path
...
export const SavedPostsIcon = () => {
    return (
        <svg aria-label="Kaydedilenler" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18" role="img"
             viewBox="0 0 24 24" width="18"><title>Kaydedilenler</title>
...
export const ChangeViewIcon = () => {
    return (
        <svg aria-label="Tema simgesi" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18" role="img"
             viewBox="0 0 24 24" width="18"><title>Tema simgesi</title>
            <path
...
export const ReportProblemIcon = () => {
    return (
        <svg aria-label="Bir sorun bildir" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18"
             role="img" viewBox="0 0 24 24" width="18"><title>Bir sorun bildir</title>
            <path
...
export const PostsIcon = () => {
    return (
        <svg aria-label="" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="12" role="img"
...
export const ProfileSettingsIcon = () => {
    return (
        <svg aria-label="Seçenekler" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="32" role="img"
             viewBox="0 0 24 24" width="32"><title>Seçenekler</title>
...
export const ChangeSharedImgSize = () => {
    return (
        <svg aria-label="Kırpmayı seç" className="x1lliihq x1n2onr6 x9bdzbf" fill="currentColor" height="16" role="img"
             viewBox="0 0 24 24" width="16"><title>Kırpmayı seç</title>
            <path
...
export const BackArrowIcon = () => {
    return (
        <svg aria-label="Geri" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Geri</title>
            <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                  x1="2.909"
                  x2="22.001" y1="12.004" y2="12.004"></line>
...
export const VerifiedAccount = ({width, height}) => {
    return (
        <svg aria-label="Doğrulanmış" className="x1lliihq x1n2onr6" fill="rgb(0, 149, 246)"
             height={height ? height : 18} role="img"
             viewBox="0 0 40 40" width={width ? width : 18}><title>Doğrulanmış</title>
            <path
...
export const CommentIcon = () => {
    return (
        <svg aria-label="Yorum Yap" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Yorum Yap</title>
...
export const SharePostIcon = () => {
    return (
        <svg aria-label="Gönderi Paylaş" className="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="24"
             role="img" viewBox="0 0 24 24" width="24"><title>Gönderi Paylaş</title>
...
export const SavePostIcon = () => {
    return (
        <svg aria-label="Kaydet" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Kaydet</title>
            <polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor"
                     strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon>
        </svg>
    )
...
export const UnlikeCommentIcon = () => {
    return (
        <svg aria-label="Beğenmekten Vazgeç" className="x1lliihq x1n2onr6 xxk16z8" height="12"
             role="img" viewBox="0 0 48 48" width="12" fill="red"><title>Beğenmekten Vazgeç</title>
            <path
...
export const CommentOptionsIcon = () => {
    return (
        <svg aria-label="Yorum Seçenekleri" className="x1lliihq x1n2onr6 x1roi4f4" fill="currentColor" height="24"
             role="img" viewBox="0 0 24 24" width="24"><title>Yorum Seçenekleri</title>
            <circle cx="12" cy="12" r="1.5"></circle>
            <circle cx="6" cy="12" r="1.5"></circle>
            <circle cx="18" cy="12" r="1.5"></circle>
        </svg>
...
export const UnlikePostIcon = () => {
    return (
        <svg aria-label="Beğenmekten Vazgeç" className="x1lliihq x1n2onr6 xxk16z8" fill="red" height="24"
             role="img" viewBox="0 0 48 48" width="24"><title>Beğenmekten Vazgeç</title>
            <path
                d="M34.6 3.1c-4.5 0-7.9 1.8-10.6 5.6-2.7-3.7-6.1-5.5-10.6-5.5C6 3.1 0 9.6 0 17.6c0 7.3 5.4 12 10.6 16.5.6.5 1.3 1.1 1.9 1.7l2.3 2c4.4 3.9 6.6 5.9 7.6 6.5.5.3 1.1.5 1.6.5s1.1-.2 1.6-.5c1-.6 2.8-2.2 7.8-6.8l2-1.8c.7-.6 1.3-1.2 2-1.7C42.7 29.6 48 25 48 17.6c0-8-6-14.5-13.4-14.5z"></path>
        </svg>
    )
...
export const NewMessageIcon = () => {
    return (
        <svg aria-label="Yeni Mesaj" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Yeni Mesaj</title>
...
export const DirectMessageIcon = ({isActive}) => {
    if (isActive) {
        return (
            <svg aria-label="Direct" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
                 viewBox="0 0 24 24" width="24"><title>Direct</title>
                <path
...
export const NoSelectedContactMessageIcon = () => {
    return (
        <svg aria-label="" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="96" role="img"
...
export const SelectEmojiIcon = () => {
    return (
        <svg aria-label="Bir ifade simgesi seç" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
             role="img" viewBox="0 0 24 24" width="24"><title>Bir ifade simgesi seç</title>
            <path
...
export const HeartIcon = () => {
    return (
        <svg aria-label="Beğen" className="x1lliihq x1n2onr6 x5n08af" fill="rgb(0,0,0)" height="24" role="img"
             viewBox="0 0 24 24" width="24"><title>Beğen</title>
            <path
                d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z"></path>
        </svg>
    )
...
export const CancelIcon = () => {
    return (
        <svg aria-label="Kapat" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="18" role="img"
             viewBox="0 0 24 24" width="18"><title>Kapat</title>
            <circle cx="12" cy="12" fill="none" r="11.25" stroke="currentColor" strokeLinejoin="round"
                    strokeWidth="1.5"></circle>
            <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
                  x1="16.604" x2="7.396" y1="7.396" y2="16.604"></line>
            <line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5"
                  x1="7.396" x2="16.604" y1="7.396" y2="16.604"></line>
        </svg>
    )
}

export const AddAnotherImageIcon = () => {
    return (
        <svg aria-label="Başka bir fotoğraf/video yükle" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor"
             height="24" role="img" viewBox="0 0 24 24" width="24"><title>Başka bir fotoğraf/video yükle</title>
...
export const AddImageIcon = () => {
    return (
        <svg aria-label="Fotoğraf veya Video Ekle" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
             role="img" viewBox="0 0 24 24" width="24"><title>Fotoğraf veya Video Ekle</title>
            <path d="M6.549 5.013A1.557 1.557 0 1 0 8.106 6.57a1.557 1.557 0 0 0-1.557-1.557Z"
                  fillRule="evenodd"></path>
            <path
                d="m2 18.605 3.901-3.9a.908.908 0 0 1 1.284 0l2.807 2.806a.908.908 0 0 0 1.283 0l5.534-5.534a.908.908 0 0 1 1.283 0l3.905 3.905"
